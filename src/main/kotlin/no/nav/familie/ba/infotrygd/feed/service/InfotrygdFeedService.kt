...
class InfotrygdFeedService(val feedRepository: FeedRepository) {
    ...
    fun opprettNyFeed(type: Type, fnrBarn: String?, fnrFar: String?, fnrMor: String?, fnrStonadsmottaker: String?, datoStartNyBA: LocalDate?) =
        feedRepository.save(Feed(type = type,fnrBarn = fnrBarn, fnrFar = fnrFar, fnrMor = fnrMor, fnrStonadsmottaker = fnrStonadsmottaker, datoStartNyBa = datoStartNyBA))
